...
```{r parseWorkspace,echo=TRUE,results='hide',eval=FALSE}
...
```{r loadgs,echo=FALSE,results='hide',message=FALSE,warning=FALSE}
...
## Extract Stats and Compare

```{r extract_stats,echo=TRUE,message=FALSE, warning=FALSE}
