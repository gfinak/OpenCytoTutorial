...
spill<-spillover(x=comp_controls,unstained="Unst 1",fsc="FSC-A",ssc="SSC-A",useNormFilt=TRUE,pregate=FALSE,stain_match="order",patt=paste(sampleNames(comp_controls)[-11],collapse="|"),method="median")
