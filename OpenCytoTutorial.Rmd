...
* Note Perforin is incorrectly gated in the manual analysis.
* Minor differences, but <emph>reproducible and objective</emph>.

## Perforin

```{r example_Perforin,echo=FALSE,eval=TRUE,fig.cap='Automated and Manual Gating of Perforin/CD8',cache=TRUE,fig.align='center',fig.width=7.5,fig.height=3.5}
...
* If the data coming off of an instrument are consistent, then an OpenCyto gating template can be reused for any data set using the same panel.
     * Work is done up front to set up the template.
     * Fully reproducible and <emph>*objective, data-driven*</emph> gating.
